...
bigTimeAgg <- drAggregate(~ timeMinute + firstSeenDestIp, ##CHANGE
...
srcIpByte <- drAggregate(firstSeenSrcPayloadBytes ~ firstSeenSrcIp, ##CHANGE
   data = nfRaw)
# merge in hostList
...
dsq <- drQuantile(nfRaw, var = "durationSeconds") ##CHANGE
...
dsqSrcType <- drQuantile(nfRaw, var = "durationSeconds", by = "type", ##CHANGE
...
dsqDestType <- drQuantile(nfRaw, var = "durationSeconds", by = "type",  ## CHANGE
   preTransFn = function(x) {
